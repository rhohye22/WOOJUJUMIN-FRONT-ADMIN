...
function PartyBbsReply() {
  ...
  function getReplylist() {
    axios
      .get("http://118.67.132.98:3000/partyReplyListAdmin", {
  ...
  function delreply(del) {
    axios
      .post("http://118.67.132.98:3000/statePartyReplyControl", null, {
